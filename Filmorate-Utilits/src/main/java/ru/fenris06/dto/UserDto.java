...
public class UserDto {
    ...
    private Long id;
    @NotBlank(message = "Field email can't be null, empty, or only with whitespace", groups = {Update.class, Create.class})
    @Email(message = "Field email must be email pattern", groups = {Update.class, Create.class})
    private String email;
    @NotBlank(message = "Field login can't be null, empty, or only with whitespace", groups = {Update.class, Create.class})
